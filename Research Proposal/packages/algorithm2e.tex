...
\begin{itemize}
  \item $\backslash$tcc\{line(s) of comment\}\macind{tcc}: comment ``锟� la'' C
  \item $\backslash$tcc*\{right justified side comment\}\macind{tcc*}: comment ``锟� la'' C
  \item $\backslash$tcc*[r]\{right justified side comment, ends the line (default)\}\macind{tcc*[r]}: comment ``锟� la'' C
  \item $\backslash$tcc*[l]\{left justified side comment, ends the line\}\macind{tcc*[l]}: comment ``锟� la'' C
  \item $\backslash$tcc*[h]\{left justified comment, without end line; useful with "if-then-else" macros for
        example\}\macind{tcc*[h]}: comment ``锟� la'' C
  \item $\backslash$tcc*[f]\{right justified comment, without end line; useful with "if-then-else" macros for
        example\}\macind{tcc*[f]}: comment ``锟� la'' C
  \item $\backslash$tcp\{line(s) of comment\}\macind{tcp}: comment ``锟� la'' C++
  \item $\backslash$tcp*\{right justified side comment\}\macind{tcp*}: comment ``锟� la'' C++
  \item $\backslash$tcp*[r]\{right justified side comment, ends the line (default)\}\macind{tcp*[r]}: comment ``锟� la'' C++
  \item $\backslash$tcp*[l]\{left justified side comment, ends the line\}\macind{tcp*[l]}: comment ``锟� la'' C++
  \item $\backslash$tcp*[h]\{left justified comment, without end line; useful with "if-then-else" macros for
        example\}\macind{tcp*[h]}: comment ``锟� la'' C++
  \item $\backslash$tcp*[f]\{right justified comment, without end line; useful with "if-then-else" macros for
        example\}\macind{tcp*[f]}: comment ``锟� la'' C++
\end{itemize}
...
\begin{enumerate}
  ...
  \item \almacppp{SetKwRepeat}{Ripeti}{ripeti}{finch锟絵
  ...
  \item \almacpppp{SetKwFor}{Finche}{finch锟絵{fai}{fine finch锟絵
\end{enumerate}
